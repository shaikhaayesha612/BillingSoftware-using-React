                ...
                <div className="container">
                    ...
                    <div className="row">
                        <div className="col-lg-9">
                            ...
                            <div className="row">
                                <div className="col-lg-3 mb-3"> <img src="1.jpg" class="img-fluid rounded"/> </div>
                                <div className="col-lg-3 mb-3"> <img src="2.jpg" class="img-fluid rounded"/> </div>
                                <div className="col-lg-3 mb-3"> <img src="3.jpg" class="img-fluid rounded"/> </div>
                                <div className="col-lg-3 mb-3"> <img src="4.jpg" class="img-fluid rounded"/> </div>
                            </div>
                        </div> 
